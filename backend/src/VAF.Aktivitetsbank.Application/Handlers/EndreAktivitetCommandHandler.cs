...
{
    public class EndreAktivitetCommandHandler : ICommandHandler<EndreAktivitetCommand>
    {
        private readonly IEventDispatcher _dispatcher;
        private readonly IAktivitetsbankService _aktivitetsbankService;

        public EndreAktivitetCommandHandler(IEventDispatcher dispatcher, IAktivitetsbankService aktivitetsbankService)
        {
            _dispatcher = dispatcher;
            _aktivitetsbankService = aktivitetsbankService;
        }

        public void Execute(EndreAktivitetCommand command)
        {
            ////Do stuff!
            ...
            _aktivitetsbankService.EndreAktivitet(command.EndreAktivitetDto);
        }
    }
}
